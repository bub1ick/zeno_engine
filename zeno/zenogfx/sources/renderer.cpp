...
void renderer_t::m_setup_camera()
{
    ...
    m_projection_matrix = DirectX::XMMatrixPerspectiveFovRH(DirectX::XM_PIDIV2, static_cast<float>(window_size.width) / static_cast<float>(window_size.height), 0.01f, 100.f);
}
